...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetDataForDatapad(variables?: GetDataForDatapadQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetDataForDatapadQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetDataForDatapadQuery>(GetDataForDatapadDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetDataForDatapad', 'query', variables);
    }
  };
}
